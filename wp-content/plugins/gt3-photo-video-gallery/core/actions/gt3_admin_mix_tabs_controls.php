			...
			'option'      => new gt3select( array(
				...
				'options' => new ArrayObject( array(
					'10' => new gt3options( array(
						...
						'value' => 'post',
						'attr'  => new ArrayObject( array( new gt3attr( 'data-link-to', 'gt3pg_link_to_post' ) ) ),
					) ),
					'20' => new gt3options( array(
						'title' => __( 'File', 'gt3pg' ),
						'value' => 'file',
						'attr'  => new ArrayObject( array( new gt3attr( 'data-link-to', 'gt3pg_link_to_file' ) ) ),
					) ),
					'30' => new gt3options( array(
						'title' => __( 'Lightbox', 'gt3pg' ),
						'value' => 'lightbox',
						'attr'  => new ArrayObject( array( new gt3attr( 'data-link-to', 'gt3pg_link_to_lightbox' ) ) ),
					) ),
					'40' => new gt3options( array(
						'title' => __( 'None', 'gt3pg' ),
						'value' => 'none',
						'attr'  => new ArrayObject( array( new gt3attr( 'data-link-to', 'gt3pg_link_to_none' ) ) ),
					) ),
				) )
			) )
		) );
